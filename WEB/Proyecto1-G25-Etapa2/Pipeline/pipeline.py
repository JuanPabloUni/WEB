...
class LemmatizeSpanishTextBatch(BaseEstimator, TransformerMixin):
    ...
    def transform(self, X):
        ...
        for i in range(num_batches):
            ...
            X_copy.iloc[start_idx:end_idx] = X_copy.iloc[start_idx:end_idx].apply(lemmatize_spanish_text)
...
data_train = pd.read_csv('Pipeline/tipo1_entrenamiento_estudiantes.csv', sep=',', encoding='utf-8')
data_test = pd.read_csv("Pipeline/particion_prueba_estudiantes.csv", sep=",", encoding="utf-8")
